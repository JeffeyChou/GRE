...
UploadStrategy.ANONYMOUS_IMGUR = new _UploadStrategy(
  "ANONYMOUS_IMGUR",
...
var ImgurAuthModal = class extends import_obsidian.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian.ButtonComponent(this.modalEl.createDiv())
  ...
  onClose() {
    return __async(this, null, function* () {
      clearInterval(this.intervalId);
      this.opened = false;
      if (this.afterClose) yield this.afterClose();
    });
  }
...
var ImgurAuthenticationStatus = class {
  ...
  addLogoutButton(el) {
    new import_obsidian2.ButtonComponent(el)
  ...
  addAuthButton(parentEl) {
    new import_obsidian2.ButtonComponent(parentEl)
...
var ImgurPluginSettingsTab = class extends import_obsidian3.PluginSettingTab {
    ...
    this.plugin.registerObsidianProtocolHandler("imgur-oauth", (params) => {
      ...
      if (params.error) {
        new import_obsidian3.Notice(
          `Authentication failed with error: ${params.error}`
        );
        return;
      }
  ...
  display() {
    ...
    new import_obsidian3.Setting(uploadApproachDiv)
...
var RemoteUploadConfirmationDialog = class extends import_obsidian4.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian4.ButtonComponent(buttonsDiv)
...
function mdImagePiecesFrom(arr) {
  ...
  return __spreadProps(
    __spreadValues(
      __spreadProps(__spreadValues({}, arr[1] && { urlPrefix: arr[1] }), {
        imgPrefix: arr[2],
        imgurhost: arr[3],
...
var isMatchUnderCursor = (match, cursorPosition) =>
...
var editorCheckCallbackFor = (size) => (checking, editor) => {
  ...
  const match = md_image_parsing_default(
  ...
  try {
    ...
    if (e instanceof Error) new import_obsidian5.Notice(e.message);
...
var ImgurPlugin = class extends import_obsidian6.Plugin {
  constructor() {
    super(...arguments);
    this.customPasteEventCallback = (e, _, markdownView) =>
      __async(this, null, function* () {
    ...
    this.customDropEventListener = (e, _, markdownView) =>
      __async(this, null, function* () {
  ...
  loadSettings() {
    return __async(this, null, function* () {
      this.settings = __spreadValues(
        __spreadValues({}, DEFAULT_SETTINGS),
        yield this.loadData()
      );
    });
  }
